package com.example.Crud.ServiceTest.ServiceTest.CriaPessoaServiceTest;
...
public class CriaPessoaServiceTest {
    ...
    public void testCriaPessoaComSucesso() {
        ...
        Pessoa pessoaCriada = criaPessoaService.criaPessoa(pessoa);
    ...
    public void testCriaPessoaComDadosInvalidos() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            criaPessoaService.criaPessoa(pessoa2);
        });
    }
    ...
    public void testCriaPessoaComCpfJaExistente() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            criaPessoaService.criaPessoa(pessoa);
        });
    }
}
